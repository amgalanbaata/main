                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <div id="reportDetails">
                            <h2 class="reportDate bg-primary text-white p-3 ">Тайлан <?php echo e($startDate ?? ''); ?> -> <?php echo e($endDate ?? ''); ?></h2>
                            <table class="table-custom">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Шийдвэрлэсэн</td>
                                        <td><?php echo e($counts['resolved'] ?? 0); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Хүлээн авсан</td>
                                        <td><?php echo e($counts['received'] ?? 0); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Татгалзсан</td>
                                        <td><?php echo e($counts['rejected'] ?? 0); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    var chart = new CanvasJS.Chart("chartContainer", {
                        ...
                        data: [{
                            ...
                            dataPoints: [
                                ...
                                {y: <?php echo e($counts['received'] ?? 0); ?>, label: "Хүлээн авсан"},
                                {y: <?php echo e($counts['resolved'] ?? 0); ?>, label: "Шийдвэрлэсэн"},
                                {y: <?php echo e($counts['rejected'] ?? 0); ?>, label: "Татгалзсан"},
                                // {y: 1.26, label: "Others"}
                            ]
                        }]
                    });
...
<?php /**PATH E:\TASTAS\SANKYU\ubsoil\laravel\resources\views/admin/report.blade.php ENDPATH**/ ?>