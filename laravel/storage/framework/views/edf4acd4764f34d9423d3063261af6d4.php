                    ...
                    <div class="content">
                        ...
                        <div>
                            <h2 id="reportDate" class="reportDate bg-primary text-white p-3">
                                Статистик <?php echo e($startDate && $endDate ? "($startDate -> $endDate)" : ' (Бүгд)'); ?>
                            ...
                            <div class="d-flex">
                                <table class="table-custom" id="reportTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Шинээр ирсэн</td>
                                            <td><?php echo e($counts['new'] ?? 0); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Давхардсан</td>
                                            <td><?php echo e($counts['Duplicated'] ?? 0); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Нэмэлт мэдээлэл шаардлагатай</td>
                                            <td><?php echo e($counts['Additional information is required'] ?? 0); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Татгалзсан</td>
                                            <td><?php echo e($counts['Refused'] ?? 0); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Хөрсний шинжилгээ хийх</td>
                                            <td><?php echo e($counts['Conduct_soil_analysis'] ?? 0); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Байршилд шууд бүртгэх</td>
                                            <td><?php echo e($counts['Register_directly_on_location'] ?? 0); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table2" id="table2">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Хог хягдал</td>
                                            <td><?php echo e($typeCounts['Хог хягдал']); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Бохир</td>
                                            <td><?php echo e($typeCounts['Бохир']); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Эвдрэл доройтол</td>
                                            <td><?php echo e($typeCounts['эвдрэл доройтол']); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Бусад</td>
                                            <td><?php echo e($typeCounts['Бусад']); ?></td>
                                        </tr>
                                        <tr>
                                            <td>Цэгээр бүртгэгдсэн</td>
                                            <td><?php echo e($registeredLocation); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php elseif(Session::get('admin_is') == 2): ?>
                                <table class="table2" id="table2">
                                    <thead>
                                        <tr>
                                            <th>Төрөл</th>
                ...
                <script>
                    ...
                    var chart = new CanvasJS.Chart("chartContainer", {
                        ...
                        data: [{
                            ...
                            indexLabel: "{label} {y}",
                            dataPoints: [
                                {y: <?php echo e($counts['new'] ?? 0); ?>, label: "Шинээр ирсэн"},
                                {y: <?php echo e($counts['Duplicated'] ?? 0); ?>, label: "Давхардсан"},
                                {y: <?php echo e($counts['Additional information is required'] ?? 0); ?>, label: "Нэмэлт мэдээлэл шаардлагатай"},
                                {y: <?php echo e($counts['Refused'] ?? 0); ?>, label: "Татгалзсан"},
                                {y: <?php echo e($counts['Conduct_soil_analysis'] ?? 0); ?>, label: "Хөрсний шинжилгээ хийх"},
                                {y: <?php echo e($counts['Register_directly_on_location'] ?? 0); ?>, label: "Байршилд шууд бүртгэх"},
                                // {y: 1.26, label: "Others"}
                            ]
                        }]
                    });
...
<?php /**PATH C:\Users\Amka\Documents\ubsoil\laravel\resources\views/admin/report.blade.php ENDPATH**/ ?>